...
@Service
@Slf4j
public class AiFewShotPromptService {

  private ChatClient chatClient;

  public String promptTemplate(String order) {
    String strPrompt = """
    ...
    Prompt prompt = Prompt.builder().content(strPrompt).build();


    String pizzaOrderJson = chatClient
      .prompt(prompt)
      .options(
        ChatOptions.builder()
        .temperature(0.0)
